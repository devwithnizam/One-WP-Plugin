...
?>
    <div class="meta-box-container" style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: space-between; align-items: center;">

        <div class="meta-box-field" style="display: flex; flex-direction: column; width: 30%;">
